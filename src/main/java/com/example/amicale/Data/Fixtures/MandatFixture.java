...
public class MandatFixture implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        president.setNom("President2024");
        ...
        president.setDateOfJoining(LocalDate.parse("2024-02-19"));
        ...
        membre1.setNom("vicepresident2024");
        ...
        membre1.setDateOfJoining(LocalDate.parse("2024-02-13"));
        ...
        membre2.setDateOfJoining(LocalDate.parse("2024-01-04"));
        ...
        membre3.setDateOfJoining(LocalDate.parse("2024-02-14"));
        ...
        membre4.setDateOfJoining(LocalDate.parse("2024-02-14"));
        ...
        membre5.setDateOfJoining(LocalDate.parse("2024-02-14"));
        ...
        mandat.setDateDebut(LocalDate.parse("2024-10-14"));
        mandat.setDateFin(LocalDate.parse("2025-10-20"));
